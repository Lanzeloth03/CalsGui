...
public class MainCalc extends javax.swing.JFrame implements ActionListener {
    ...
    public void btnInicio() {
        ...
        for (int i = 0; i < 20; i++) {
            boton[i] = new JButton(contenidoCalc[i]);
    ...
    private void initComponents() {
        ...
        jPanelButton.setBackground(new java.awt.Color(153, 255, 0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtResult, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
